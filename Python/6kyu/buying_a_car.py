...
def nbMonths(start_price_old, start_price_new, saving_per_month, percent_loss_by_month):
    ...
    while savings + start_price_old <= start_price_new:
        if increase == 2:
            percent_loss_by_month += 0.5
            increase = 0
        start_price_old = start_price_old * (1- percent_loss_by_month * .01)
        start_price_new = start_price_new * (1- percent_loss_by_month * .01)    
